# Numerology app: based on the birth path number. The birth path number is determined by doing a little math with your date of birth. Your birthdate is reduced down to a single digit, 1-9. That number corresponds to a specific message about your path in life and place in the world.
...
# 4. convert the number back to a string to use array syntax again, and then follow step 3 to add the two numbers together
number = number.to_s
...
when 9
  ...
  puts "Oh no! Your birth path number is not 1-9!"
end
